...
import {
  ...
  Clock24Regular, Warning24Regular, Comment24Regular, Alert24Regular, DismissCircle24Regular,
...
const typeIcons: Record<string, { icon: React.ReactNode; bg: string; color: string }> = {
  ...
  LEAVE_REJECTED: { icon: <DismissCircle24Regular />, bg: 'var(--color-danger-bg)', color: 'var(--color-danger)' },
